...
FIREWALL_LAN_IP=$(docker inspect firewall | jq -r '.[0].NetworkSettings.Networks."secure-segmented-network-simulation_lan_net".IPAddress')
FIREWALL_DMZ_IP=$(docker inspect firewall | jq -r '.[0].NetworkSettings.Networks."secure-segmented-network-simulation_dmz_net".IPAddress')
FIREWALL_WAN_IP=$(docker inspect firewall | jq -r '.[0].NetworkSettings.Networks."secure-segmented-network-simulation_wan_net".IPAddress')
...
ATTACKER_WAN_IP=$(docker inspect attacker | jq -r '.[0].NetworkSettings.Networks."secure-segmented-network-simulation_wan_net".IPAddress')
